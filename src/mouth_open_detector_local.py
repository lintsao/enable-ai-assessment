...
def main():
    parser = argparse.ArgumentParser(description="Detect mouth existence and state (open/closed)")
    parser.add_argument("--video", type=str, default=None, help="Path to video file; if omitted, use webcam")
    ...
    while True:
        ...
        cv2.putText(frame, f"Mouth: {state}", (30,40), cv2.FONT_HERSHEY_SIMPLEX, 1, color, 2)
